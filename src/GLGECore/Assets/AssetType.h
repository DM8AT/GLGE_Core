 ...
 * @file AssetType.h
 * @author DM8AT
 * @brief define handling of asset types
 * @version 0.1
 * @date 2025-10-23
 * 
...
//header guard
#ifndef _GLGE_CORE_ASSETS_ASSET_TYPE_
#define _GLGE_CORE_ASSETS_ASSET_TYPE_
...
static_assert(AssetTypeRegistry::getID<int>() == 4043213090, "Invalid type ID registered for type \"int\"");
static_assert(AssetTypeRegistry::getID<float>() == 572149578, "Invalid type ID registered for type \"float\"");
